        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form class="space-y-4 md:space-y-6" wire:submit.prevent='login()'>
                ...
                <div>
                    ...
                    <input type="password" wire:model='password' placeholder="{{ __("Mot de passe") }}" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5  " required="">
